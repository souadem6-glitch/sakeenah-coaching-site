          ...
          {[
            {
              ...
              tekst:"Deze algemene voorwaarden zijn van toepassing op alle begeleidingstrajecten en sessies aangeboden door Sakeenah Coaching, gevestigd in Antwerpen."
            },
            {
              titel:"Afspraken en boekingen",
              tekst:"Afspraken worden uitsluitend gemaakt via de online boekingstool op de website. Na boeking ontvang je een bevestiging. De boeking is pas definitief na ontvangst van deze bevestiging."
            },
            {
              titel:"Annulering en verplaatsing",
              tekst:"Annuleren of verplaatsen kan uitsluitend tot 72 uur voor de geplande sessie. Bij annulering of verplaatsing binnen de 72 uur wordt de volledige sessie aangerekend via factuur. Sakeenah Coaching behoudt het recht om een sessie te verplaatsen bij overmacht."
            },
            {
              titel:"Betaling",
              tekst:"Betaling gebeurt na elke sessie, cash of via QR-code (Payconiq of Bancontact). Bij laattijdige annulering wordt een factuur opgemaakt die binnen 14 dagen betaald dient te worden."
            },
            {
              titel:"Tarieven",
              tekst:"Een sessie duurt 60 minuten en kost € 60. Tarieven kunnen worden herzien. Wijzigingen worden vooraf gecommuniceerd aan lopende cliënten."
            },
            {
              titel:"Vertrouwelijkheid",
              tekst:"Alles wat besproken wordt tijdens sessies is strikt vertrouwelijk. Sakeenah Coaching deelt geen informatie over cliënten met derden, tenzij wettelijk verplicht."
            },
            {
              titel:"Aansprakelijkheid",
              tekst:"Sakeenah Coaching is niet aansprakelijk voor beslissingen die de cliënt neemt op basis van de begeleiding. Coaching is geen vervanging voor medische of psychologische behandeling."
            },
            {
              titel:"Toepasselijk recht",
              tekst:"Deze voorwaarden vallen onder het Belgisch recht. Bij geschillen wordt in eerste instantie gezocht naar een minnelijke oplossing."
            },
          ].map((s, i) => (
