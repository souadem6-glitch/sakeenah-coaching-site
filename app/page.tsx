  ...
  return (
    <main style={{fontFamily:"Georgia,serif",color:"#2C2420"}}>
      <style>{`
        ...
        .sk-hero-img { width:420px; height:420px; flex-shrink:0; overflow:hidden; }
        ...
        @media (max-width: 768px) {
          ...
          .sk-hero-img { width:100%; height:280px; }
      ...
      <section className="sk-hero">
        <div className="sk-hero-inner">
          ...
          <div className="sk-hero-img">
            <img src="/PraktijkCoaching_filter.jpg" alt="Praktijkruimte Sakeenah Coaching" style={{width:"100%",height:"100%",objectFit:"cover",objectPosition:"center top"}} />
          </div>
        </div>
      </section>
