    ...
    <main style={{fontFamily:"Georgia,serif",color:"#2C2420"}}>
      ...
      <section id="over" style={{background:"#fff",padding:"80px 0"}}>
        <div className="sk-over-inner">
          ...
          <div style={{flex:1}}>
            ...
            <p style={{fontSize:"15px",color:"#7a6a62",lineHeight:1.9,fontFamily:"sans-serif",fontWeight:300,textAlign:"justify",marginTop:"16px"}}>Als hoogbegaafde vrouw met ADHD en autisme beschik ik over een sterk inlevingsvermogen en een scherp analytisch inzicht. Ik begrijp mijn cliënten niet alleen vanuit mijn opleiding, maar ook vanuit eigen ervaring. Met empathie, rechtvaardigheid en heldere communicatie help ik mensen grip te krijgen op wat hen bezighoudt.</p>
          </div>
        </div>
      </section>
      ...
      <section id="boeken" style={{background:"#fff",padding:"80px 0"}}>
        <div className="sk-boeken-inner">
          ...
          <p style={{fontSize:"14px",color:"#7a6a62",fontFamily:"sans-serif",fontWeight:300,marginBottom:"10px"}}>Een sessie duurt 60 minuten en kost € 60.</p><p style={{fontSize:"14px",color:"#7a6a62",fontFamily:"sans-serif",fontWeight:300,marginBottom:"40px"}}>Annuleren is niet mogelijk binnen 72 uur voor het geplande tijdstip; anders wordt de afspraak in rekening gebracht.</p>
